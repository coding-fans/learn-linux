...
author = u'fasionchan'
site_domain = os.environ.get('SITE_DOMAIN', 'linux.fasionchan.com')
...
htmlhelp_basename = 'LinuxBookdoc'
...
latex_documents = [
    (master_doc, 'Linux.tex', u'学习Linux Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'linux', u'学习Linux Documentation',
     [author], 1)
]
